...
@pytest.mark.parametrize("test_input, expected", 
                            [
                                ...
                                ('/trigger?timestamp=1669899025.0759895&event=done', json.dumps({'reponse_code':'accepted', 'message':"1 validation error for EventModel\nevent\n  Event is not valid or you are not allowed to trigger event. (type=value_error)"})),
                                ('/trigger?timestamp=1669899025.0759895&event=clearancetimeout', json.dumps({'reponse_code':'accepted', 'message':"1 validation error for EventModel\nevent\n  Event is not valid or you are not allowed to trigger event. (type=value_error)"}))
                            ])
